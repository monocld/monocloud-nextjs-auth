...
describe('isAppRouter', () => {
  test('should return true for app router request', () => {
    const req = new NextRequest('http://example.com');
    expect(isAppRouter(req)).toBe(true);
  });

  test('should return false for other types of requests', () => {
    const req = {};
...
describe('getMonoCloudReqRes', () => {
  test('should return MonoCloudRequest and MonoCloudResponse for app router request', () => {
    const req = new NextRequest('http://example.com');
  ...
  test('should return MonoCloudRequest and MonoCloudResponse for page router request', () => {
    const req = {};
    const resOrCtx = {};
...
describe('mergeResponse', () => {
  test('should merge responses correctly', () => {
